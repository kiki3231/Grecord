...
import com.ma.grecorde.service.UserAchievementService;
import com.ma.grecorde.mapper.UserAchievementMapper;
import org.springframework.stereotype.Service;

/**
* @author 19135
* @description 针对表【user_achievement(用户成就表)】的数据库操作Service实现
